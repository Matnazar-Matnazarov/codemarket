    ...
    <div class="group bg-white dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-5 border border-gray-100/10 dark:border-gray-700/50 transform hover:-translate-y-2">
        <div class="relative overflow-hidden rounded-xl">
            ...
            <div class="absolute top-3 right-3 flex gap-2">
                ...
                <span class="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium flex items-center gap-1">
        ...
        <div class="mt-4 space-y-3">
            ...
            <div class="pt-4 flex justify-between items-center border-t border-gray-100 dark:border-gray-700/50">
                <div class="flex items-center gap-2">
                    <span class="bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent text-2xl font-bold flex items-center gap-2">
                        ${product.price}
                    ...
                    <span class="text-gray-600 dark:text-gray-400 font-medium">Coins</span>
                </div>
